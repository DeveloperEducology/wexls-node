    ...
    return (
        <div className="container relative h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
            ...
            <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
                ...
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=2022&auto=format&fit=crop')] bg-cover bg-center opacity-20 mix-blend-overlay" />
            ...
            <div className="lg:p-8 h-full flex items-center justify-center">
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    ...
                    <div className="grid gap-6">
                            ...
                            <div className="grid gap-4">
                                ...
                                <div className="grid gap-2">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Link href="#" className="text-sm text-green-600 hover:underline">Forgot password?</Link>
                                    </div>
                                    <Input
                                        id="password"
                                        placeholder="••••••••"
                        ...
                        <Button variant="outline" type="button" disabled={isLoading} onClick={() => router.push('/dashboard')}>
                        ...
                        <p className="px-8 text-center text-sm text-muted-foreground">
                            ...
                            <Link href="/register" className="underline underline-offset-4 hover:text-primary text-green-600">
                                Sign up
                            </Link>
                        </p>
                    </div>
