...
class CustomAppBar extends StatelessWidget {
  final int index;
  const CustomAppBar({super.key, this.index = 1});
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Text(
                        index == 1
                            ? value.getAppBarTitle ?? AppLocalizations.of(context)
                                    .translate("my_feed")
                            : AppLocalizations.of(context)
                                .translate("discover"),
      ...
      if (provider.gethasDataLoaded) {
        return provider.getCurentArticalIndex == 0
            ...
            : IconButton(
                ...
                onPressed: () {
                  if (provider.getfeedPageController != null) {
                    bringToTop(provider.getfeedPageController!);
                  }
                });
      } else {
        return const IconButton(icon: Icon(FeatherIcons.loader), onPressed: null);
      }
    }
  }
