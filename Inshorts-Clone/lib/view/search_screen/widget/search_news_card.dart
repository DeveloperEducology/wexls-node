...
class SearchNewsCard extends StatelessWidget {
  ...
  const SearchNewsCard({super.key, required this.articles, required this.index});
  @override
  Widget build(BuildContext context) {
    var article = articles[index];

    return GestureDetector(
      onTap: () => SimpleRouter.navigator.pushNamed(
        SimpleRouter.feedScreen,
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: Text(
                        article.publishedAt != null ? DateFormat("MMMM d").format(
