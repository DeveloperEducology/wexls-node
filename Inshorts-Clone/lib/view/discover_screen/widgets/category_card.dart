...
class CategoryCard extends StatelessWidget {
  ...
  const CategoryCard(
      {super.key, required this.icon, required this.title, required this.onTap, this.active = false});
          ...
          children: <Widget>[
            Opacity(
              ...
              child: Image.asset(
                ...
                width: 70,
                fit: BoxFit.contain,
                errorBuilder: (context, error, stackTrace) => const Icon(Icons.category, size: 70),
              ),
            ),
            Text(
              title,
